                ...
                <div className="flex flex-wrap items-center justify-between gap-2 pb-4 lg:flex-nowrap">
                    <div>
                        <Title title={stats.name}>
                            <>
                                <span className="font-normal opacity-50">Database:</span> <span className="font-mono text-sm">{stats.name}</span>
                            </>
                        </Title>
                        <p className="mb-4 text-sm">
                            Tables: {stats.collections}, Rows: {totalRecords}
                        </p>
                        ...
                        <div key={index} className="mb-3 bg-neutral-100">
                            <div className="flex flex-wrap items-center justify-between gap-2 px-4 py-2 text-base border-b border-solid border-neutral-200">
                                <span className="flex items-center gap-1">
                                    <DatabaseIcon /> <strong className="font-mono text-sm">{collection.name}</strong>
                                </span>
                                <div className="flex flex-wrap items-center gap-2">
                                    <Button
                                        variant={"error"}
                            ...
                            <div className="grid grid-cols-2 gap-2 px-4 py-2 lg:grid-cols-5">
                                ...
                                <div className="flex flex-col text-sm">
                                    <span className="block mb-1 font-bold">Records:</span>
                                    <span className="font-normal">{collection.count}</span>
                                </div>
                                <div className="flex flex-col text-sm">
                                    <span className="block mb-1 font-bold">Avg. record size:</span>
                                    <span className="font-normal">{convertBytes(avgRecordSize)}</span>
                                </div>
                                <div className="flex flex-col text-sm">
                                                ...
                                                <Table className="mt-4 text-md lg:mt-0">
                                                    <TableBody>
                                                        <TableRow>
                                                            ...
                                                            <TableCell>{numberWithCommas(collection.stats.queryExecStats?.liveTuples)}</TableCell>
                                                        </TableRow>
                                                        <TableRow>
                                                            <TableCell className="font-bold">Tuples Inserted</TableCell>
                                                            <TableCell>{numberWithCommas(collection.stats.queryExecStats?.inserted)}</TableCell>
                                                        </TableRow>
                                                        <TableRow>
                                                            <TableCell className="font-bold">Tuples Updated</TableCell>
                                                            <TableCell>{numberWithCommas(collection.stats.queryExecStats?.updated)}</TableCell>
                                                        </TableRow>
                                                        <TableRow>
                                                            <TableCell className="font-bold">Tuples Deleted</TableCell>
                                                            <TableCell>{numberWithCommas(collection.stats.queryExecStats?.deleted)}</TableCell>
                                                        </TableRow>
                                                        <TableRow>
                                                            <TableCell className="font-bold">Sequential Scans</TableCell>
                                                            <TableCell>{numberWithCommas(collection.stats.queryExecStats?.seqScans)}</TableCell>
                                                        </TableRow>
                                                        <TableRow>
                                                            <TableCell className="font-bold">Index Scans</TableCell>
                                                            <TableCell>{numberWithCommas(collection.stats.queryExecStats?.idxScans)}</TableCell>
                                                        </TableRow>
                                                    </TableBody>
                                                </Table>
                                            </div>
