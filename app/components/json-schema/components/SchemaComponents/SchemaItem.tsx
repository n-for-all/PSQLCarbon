...
export default function SchemaItem({ name, data, prefix, showAdv }: SchemaItemProps) {
    ...
    const handleChangeName = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        context.changeNameAction(prefixArray, name, valueName);
    };
    ...
    const handleDeleteItem = () => {
        ...
        context.enableRequireAction(prefixArray, name, false);
    };
    ...
    const handleAddField = () => {
        const prefixArray = prefix ? prefix.split(".") : [];
        context.addFieldAction(prefixArray, name);
    };
    ...
    const handleEnableRequire = (checked) => {
        const prefixArray = prefix ? prefix.split(".") : [];
        context.enableRequireAction(prefixArray, name, checked);
    };

    const prefixArr = prefix ? prefix.split(".") : [];
    const prefixArray = [...prefixArr, name];
