                ...
                <Form aria-label="Database Connection form" autoComplete="new-password">
                    <div className="flex flex-col gap-4">
                        ...
                        <div>
                            ...
                            />
                            <a className="text-xs text-blue-600 hover:underline" target="_blank" href="https://www.postgresql.org/docs/current/libpq-connect.html#LIBPQ-CONNSTRING">
                                View Documentation
                            </a>
                            <small className="block mt-1">
                                <b>*</b>Use <b>"sslmode=require"</b> parameter to enforce secure connections.
                            </small>
                        </div>
                        <Checkbox
                            labelText="TLS"
